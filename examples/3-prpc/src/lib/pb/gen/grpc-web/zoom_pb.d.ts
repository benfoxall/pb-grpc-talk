...
export class SystemInfo extends jspb.Message {
  ...
  addCpuloads(value: number, index?: number): void;
...
export class ColorSchemeRequest extends jspb.Message {
  getScheme(): ColorSchemeRequest.Scheme;
  setScheme(value: ColorSchemeRequest.Scheme): void;
...
export namespace ColorSchemeRequest {
  export type AsObject = {
    scheme: ColorSchemeRequest.Scheme,
  }
